...
El objetivo de este repositorio es demostrar mis metodologías de trabajo en:
* Transformación de necesidades de negocio en requerimientos técnicos ágiles.
* Redacción de criterios de aceptación bajo el estándar Gherkin (BDD).
* Identificación de riesgos, reglas críticas de negocio y diseño de casos de prueba de punta a punta (E2E).
